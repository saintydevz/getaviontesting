      ...
      <div className="bg-[#111116]/80 backdrop-blur-xl border border-white/[0.08] rounded-full px-8 py-3.5 flex items-center gap-12 shadow-2xl">
        ...
        {user ? (
          <button
            ...
            className={`text-[12px] font-bold px-5 py-1.5 rounded-full transition-all active:scale-95 ${currentView === 'dashboard' ? 'bg-white text-black' : 'bg-[#ad92ff] text-[#1a1a2e] hover:brightness-110'
              }`}
          >
            Dashboard
          </button>
